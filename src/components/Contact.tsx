...
export default function Contact() {
  return (
    <section>
      <header className='mx-auto h-48 max-w-6xl bg-white antialiased dark:bg-gray-800'>
        <h1 className='py-20 text-center text-5xl font-bold md:text-left md:text-9xl'>
          Contact
        </h1>
      </header>
      <div className='relative z-10 mx-auto -mt-4 mb-20 max-w-6xl rounded-md bg-[#02044A] p-4 shadow-md md:p-10 lg:p-20'>
        <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
          <div className='md:ml-4'>
            ...
            <div className='icons-container my-20 inline-flex flex-col'>
              <div className='flex flex-row items-center space-x-6 rounded-md border border-[#02044A] p-4 hover:border-blue-500'>
                <svg
          ...
          <form className='form flex flex-col rounded-lg bg-white p-4 md:space-y-4'>
            ...
            <input
              title='name'
              type='text'
              className='mx-4 rounded-md border px-1 py-2 font-light ring-blue-500 focus:border-none focus:ring-2 focus:outline-none'
              name='name'
            />
